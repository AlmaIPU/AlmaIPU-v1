...
const AlmaIPU = () => (
  <Image alt="Logo" src={Logo} width={70} height={70} className="px-1 mb-6" />
);
              ...
              {links
                ...
                .map((link, idx) => (
                  <SidebarLink
                    key={idx}
                    link={link}
                    className="hover:bg-[#FFFFFF] text-[#FFFFFF] rounded-lg p-2 hover:text-[#121C42]"
                  />
                ))}
            </div>
